...
$query = mysqli_query($conn,"SELECT * FROM admin where name = '".$_POST['uname']."' AND password = '".$password."'") or die(mysql_error()); 
if($query->num_rows == 1){
...
<div class="login-box">
  ...
  <img src="../img/logo.png" clss="img-responsive" height="150px" >
