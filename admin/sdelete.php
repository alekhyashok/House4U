	 ...
	 <div class="box">
		    ...
		    ?>
                <tr>
				  ...
				  <td><a href="sdelete1.php?id=<?php echo $stu['id']; ?>"><button class="btn btn-danger btn-flat" type="submit" onClick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-times" aria-hidden="true"></i></button></a></td>
                </tr>
		<?php } ?>	
				</tbody>
              </table>
