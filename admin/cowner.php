...
$sql = mysqli_query ($conn,'INSERT INTO owner (ownerId , title , firstName , middleName , lastName , phoneNumber , dateOfBirth , address , idProff)VALUES ("'.$_POST["ownerId"].'", "'.$_POST["title"].'" , "'.$_POST["firstName"].'" , "'.$_POST["middleName"].'" , "'.$_POST["lastName"].'" , "'.$_POST["phoneNumber"].'" , "'.$_POST["dateOfBirth"].'" ,  "'.$_POST["address"].'" , "'.$file.'")');
}}
?>
<!DOCTYPE html>
<html>
  ...
  <section class="content-header">
	...
	<div class="col-md-6 col-md-offset-2">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label"><span class="color">*</span>Owner Id</label>

                  <div class="col-sm-9">
                     <input type="text" name="ownerId" id="firstName"  class="form-control"  value="<?php echo uniqid(); ?>" required>
                  </div>
                </div>
                <div class="form-group">
				...
				<div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label"><span class="color">*</span>Address</label>
				<div class="col-sm-9">
