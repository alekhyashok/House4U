				...
				<div class="col-sm-6" style="border:1px solid black; padding:10px;">
                	...
                	<form action="" method="post" name="login" enctype="multipart/form-data">
                  	<div class="form-group">
                       ...
                       <input type="text" name="studentId"  class="form-control" id="studentId" value="<?php echo uniqid(); ?>" readonly>
                    </div>
                    <div class="form-group">
                       ...
                       <input type="date" name="dateOfBirth" id="dateOfBirth"  class="form-control datetimepicker2"  placeholder="Enter Date Of Birth" required>
                       </div>
                       <div class="form-group">
                        <label for="gender"><span class="color">*</span>Gender&nbsp;&nbsp;&nbsp;&nbsp;</label>
                       <div class="form-check form-check-inline">
                        ...
                        <div class="form-group">
                        <label for="FormControlFile1"><span class="color">*</span>Confirmation Letter &nbsp;&nbsp;<span style="color:red; font-size:11px;">(Please Upload only in pdf format)</span></label>
    				    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="cLetter" required>
                        </div>
                        <div class="form-group">
                        <label for="college"><span class="color">*</span>College</label>
