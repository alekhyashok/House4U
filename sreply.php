<?php
    ...
    $semail = base64_decode($_REQUEST['id']);
	$oemail = base64_decode($_REQUEST['ownid']);
	...
	if(isset($_POST["submit"])){
	  ...
	  ("'.$semail.'","'.$oemail.'","'.$_POST['message'].'","Student","'.$date.'","0","'.$accNumber.'")');
	  $sql = mysqli_query ($conn,'UPDATE chating set status = "1" where id ="'.$mid.'" ');
	  echo'<script>
	  alert("Message Sent Successfully");
	  window.location="smessage.php";</script>';
	}
?> 
<!DOCTYPE html>
<html lang="en">
				...
				<div class="col-sm-6" style="border:1px solid black; padding:10px;">
                	...
                	<form action="" method="post">
                  	<div class="form-group">
                       ...
                       <input type="text" name="email"  class="form-control" value="<?php echo base64_decode($_REQUEST['ownid']); ?>" readonly>
                    </div>
                    <div class="form-group">
